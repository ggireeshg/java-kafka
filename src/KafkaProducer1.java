...
public class KafkaProducer1 {
    public static void main(String[] args) {
        ...
        try {
            for (int i = 0; i < 10; i++) {
                String message = "Message From Producer 1 " + i;
...
/*
// Specify the partition by providing the partition number (e.g., 0)
                int partition = 0; // Change this to the desired partition number
 */